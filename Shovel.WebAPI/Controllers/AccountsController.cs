...
using Shovel.WebAPI.Abstractions.Model.Identity;
...
namespace Shovel.WebAPI.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        private readonly ShovelContext _context;
        private readonly ITokenService _tokenService;
        private readonly IConfiguration _configuration;

        public AccountsController(ITokenService tokenService, ShovelContext context, UserManager<ApplicationUser> userManager, IConfiguration configuration)
        {
